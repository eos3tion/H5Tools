...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/6d6e460e2ae87f6726ae6b0281b313bfd69385b8/electron/index.d.ts
declare namespace Electron {
	...
	class NativeImage {
		 ...
		 * 修改图片尺寸
		 * 
		 * @param {NativeImageResizeOpiton} options
		 */
		resize(options: NativeImageResizeOpiton)
	}

	/**
	 * 如果只指定了高度或宽度然后才会保留当前的纵横比，调整图片大小
	 * 
	 * @interface NativeImageResizeOpiton
	 */
	interface NativeImageResizeOpiton {
		 ...
		 * 缩放图片的质量，默认：best
		 * 
		 * @type {("best" | "better" | "good")}
		 * @memberOf NativeImageResizeOpiton
		 */
